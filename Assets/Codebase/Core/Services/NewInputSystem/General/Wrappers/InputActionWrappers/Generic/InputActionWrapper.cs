...
namespace Codebase.Core.Services.NewInputSystem.General.Wrappers.InputActionWrappers.Generic
{
    public class InputActionWrapper<T> : IInputActionWrapper where T : struct
    {
        ...
        )
        {
            ...
            (
                new VirtualActionInfo<T>
                (
                    _id,
                    callbackContext.ReadValue<T>(),
                    isDown,
                    isPressed,
                    isUp
                )
